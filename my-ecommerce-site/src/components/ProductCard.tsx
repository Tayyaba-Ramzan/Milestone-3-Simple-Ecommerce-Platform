    ...
    <>
      {cartItems.length > 0 ? (
        ...
        <div className="flex flex-col  items-center justify-center pt-7 md:pt-1">
          ...
          <button className="bg-gray-900 text-white hover:text-gray-900 hover:bg-slate-100 hover:bg-transparent lg:text-lg duration-300 scroll-m-20 text-base hover:shadow-md font-semibold tracking-tight p-4 capitalize rounded-xl px-8 mt-5">
