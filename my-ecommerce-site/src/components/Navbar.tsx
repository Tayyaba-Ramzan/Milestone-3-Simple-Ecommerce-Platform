  ...
  return (
    <div className="bg-gray-900 text-white py-4 sticky top-0 z-10 px-4 sm:px-8 md:px-16 shadow-md">
      <div className="w-full flex items-center justify-between">
        <Link
          href="/"
          className="text-xl sm:text-2xl md:text-4xl font-extrabold hover:text-[#FFD700] transition duration-300 flex-1 text-center sm:text-left pt-1"
        >
          Jewel&apos;s Store
        </Link>
        ...
        <div className="flex flex-1 justify-center gap-3 md:gap-14  font-medium items-center mt-2">
          <Link href="/" className="navLink hover:text-[#FFD700] transition duration-30 lg:text-xl">
            Home
          </Link>
          <Link
            href="/allCategory"
            className="navLink hover:text-[#FFD700] transition duration-30 lg:text-xl"
          >
            Products
          </Link>
          <Link
            href="/contact"
            className="navLink hover:text-[#FFD700] transition duration-30 lg:text-xl mr-4"
          >
            Contact
          </Link>
        </div>
        ...
        <Link href={"/card"} className="navLink">
          <div className="flex gap-4 sm:ml-8 text-[26px]">
            <div className="relative cursor-pointer hover:text-[#FFD700]">
             ...
             text-black text-[14px] grid place-items-center bg-white font-semibold  "
                >
                  {cartCount.length}
                </div>
              )}
